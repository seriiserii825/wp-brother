...
=======
	register_post_type('address', array(
		'labels' => array(
			'name' => __('Address', 'bs-brother'), // Основное название типа записи
			'singular_name' => __('Address', 'bs-brother'), // отдельное название записи типа Book
			'add_new' => __('Add new', 'bs-brother'),
			'add_new_item' => __('Add new', 'bs-brother'),
			'edit_item' => __('Edit new', 'bs-brother'),
			'new_item' => __('New item', 'bs-brother'),
			...
			'search_items' => __('Search', 'bs-brother'),
			'parent_item_colon' => '',
			'menu_name' => __('Address', 'bs-brother')
		...
		'hierarchical' => false,
		'menu_position' => null,
		'menu_icon' => get_template_directory_uri().'/site/assets/i/address.png',
		'supports' => array('title', 'editor', 'thumbnail')
	));
